...
def _dataset():
    ...
    dset_database = dp.DatasetProcessingNUS_WIDE('data/NUS-WIDE', 'database_img.txt', 'database_label.txt',
                                                 transformations)
    dset_test = dp.DatasetProcessingNUS_WIDE('data/NUS-WIDE', 'test_img.txt', 'test_label.txt', transformations)
